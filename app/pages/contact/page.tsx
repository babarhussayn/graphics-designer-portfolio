      ...
      <div className="w-full flex justify-center items-center flex-col">
        ...
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <form action="" ref={form} onSubmit={sendEmail} className="space-y-8">
            ...
            <Button
              type="submit"
              className="py-3 px-5 text-sm font-medium text-center text-black rounded-full bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
            >
              Send message
            </Button>
          </form>
